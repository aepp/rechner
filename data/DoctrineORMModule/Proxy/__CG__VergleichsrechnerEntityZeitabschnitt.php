 ...
 */
class Zeitabschnitt extends \Vergleichsrechner\Entity\Zeitabschnitt implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Zeitabschnitt $proxy) {
    ...
    public function getZeitabschnittId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getZeitabschnittId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getZeitabschnittId', array());

        return parent::getZeitabschnittId();
    }
    ...
    public function setZeitabschnittName($zeitabschnittName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setZeitabschnittName', array($zeitabschnittName));

        return parent::setZeitabschnittName($zeitabschnittName);
    }
    ...
    public function getZeitabschnittName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getZeitabschnittName', array());

        return parent::getZeitabschnittName();
    }
