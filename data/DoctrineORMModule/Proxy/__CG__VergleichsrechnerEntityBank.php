 ...
 */
class Bank extends \Vergleichsrechner\Entity\Bank implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setBankLogo($bankLogo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBankLogo', array($bankLogo));

        return parent::setBankLogo($bankLogo);
    }
